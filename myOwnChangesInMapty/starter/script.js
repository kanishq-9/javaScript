...
class App {
  ...
  constructor() {
    ...
    btnCloseModel.addEventListener('click', this._modelFunc.bind(this));
    overlay.addEventListener('click', this._modelFunc.bind(this));
  }
  ...
  _getPosition() {
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        ...
        function () {
          modal.querySelector('p').textContent = 'Cannot get your location!!🔴';
  ...
  _newWorkout(event) {
    ...
    const alertFunc = function () {
      modal.querySelector('p').textContent = 'it should be a positive number';
      modal.classList.remove('hidden');
      overlay.classList.remove('hidden');
    };
